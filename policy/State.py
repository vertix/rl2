...
class LivingUnitState(State):
    def __init__(self, unit, me, game, world):
...
class ZeroState(LivingUnitState):
    def __init__(self):
        super(ZeroState, self).__init__(None, None, None, None)
...
class WizardState(LivingUnitState):
    def __init__(self, w, me, game, world):
        super(WizardState, self).__init__(w, me, game, world)
...
class BuildingState(LivingUnitState):
    def __init__(self, b, me, game, world):
        super(BuildingState, self).__init__(b, me, game, world)
...
class MinionState(LivingUnitState):
    def __init__(self, m, me, game, world):
        super(MinionState, self).__init__(m, me, game, world)
...
class MyState(WizardState):
    ...
    @property
    def aggro(self):
        return GetAggro(self.me, self.game, self.world, 20) #safe_distance
...
class WorldState(State):
    def __init__(self, me, world, game):
        ...
        states = [WizardState(w, me, game, world) for w in world.wizards if w != me]
        states += [MinionState(m, me, game, world) for m in world.minions
                   if m.faction not in [Faction.NEUTRAL, Faction.OTHER]]
        states += [BuildingState(b, me, game, world) for b in world.buildings]
